package com.phaetonet.unicorn.shiro.manager.impl;
 ...
 * @see com.phaetonet.unicorn.shiro.manager.TokenManager
 * @author ScienJus
 * @date 2015/7/31.
 */
@Component
public class MyRedisTokenManager implements TokenManager {
