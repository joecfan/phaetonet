package com.phaetonet.unicorn.login.support;
...
public class CustomInvocationSecurityMetadataSourceService implements
    ...
    private void loadResourceDefine() {   //一定要加上<span style="font-family: Arial, Helvetica, sans-serif;">@PostConstruct注解</span></span>
