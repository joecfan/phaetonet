...
import toastr from "../toastr/toastr.min";
...
var MessageHelper = {
    ...
    error: function(message, title, position, timeOut, progressBar, callback){
        ...
        if (!timeOut) {
            toastr.options.timeOut = (config.DEFAULT_MESSAGE_ERROR_TIMEOUT_S || 60) * 1000;
            toastr.options.extendedTimeOut = (config.DEFAULT_MESSAGE_ERROR_EXTENDED_TIMEOUT_S || 60) * 1000;
        }
